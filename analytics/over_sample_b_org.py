...
sample_times = 10
# 6602
rows_std = open('../telugu_dataset/total_over_sampled.csv', 'r').readlines()
rows_std = rows_std[1:]

# Over Sample the Dataset
rows = open('../telugu_dataset/total_over_sampled.csv', 'r').readlines()
title = rows[0]
rows = rows[1:]
...
file = open("../telugu_dataset/total_over_sampled_v2.csv", "w+")

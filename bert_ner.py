...
number_words = len(words_list)  # number of unique words in the corpus
...
print(labels[0])  # list of lists of dimension (sentences,labels)
tags2vals = list(set(input_data["Tag"].values))
tag2idx = {t: i for i, t in enumerate(tags2vals)}  # 17 kinds of tags  # indexing the tag
